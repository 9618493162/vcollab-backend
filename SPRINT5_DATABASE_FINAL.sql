-- Sprint 5 Database Setup (FINAL - Fixed UUID vs TEXT issue)
-- Run these SQL commands in your Supabase SQL Editor

-- 1. Add password column to meetings table
...
-- 6. Create RLS Policies for user_settings (FIXED: Cast auth.uid() to TEXT)
...
-- 7. Create RLS Policies for chat_messages (FIXED: Cast auth.uid() to TEXT)
DROP POLICY IF EXISTS "Users can view messages in their meetings" ON chat_messages;
...
-- 9. Create trigger for user_settings
...
-- Success! Sprint 5 database setup complete.
